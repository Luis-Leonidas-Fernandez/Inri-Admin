...
class _BasePageState extends State<BasePageMobile> {
...
class SelectArea extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double responsiveTop = responsiveUtil.getResponsiveHeight(0.12);
      ...
      children: [
        ...
        Stack(
          ...
          Positioned(
           ...
           Positioned(
            top: responsiveUtil.getResponsiveHeight(0.38),
            left: responsiveLeft,
      ...
      Stack(
       ...
       Stack(
        children: [
         ...
         Positioned(
            top: responsiveUtil.getResponsiveHeight(0.31),
